...
namespace CI.QuickSave
{
    public abstract class QuickSaveBase
    {
        ...
        public static bool CheckIfRootExists(string rootName)
        {
            var json = FileAccess.LoadString(rootName, false);
            if (string.IsNullOrEmpty(json))
            {
                return false;
            }
        ...
        public static void DeleteSave(string rootName)
        {
            FileAccess.Delete(rootName, false);
        }
    }
}